...
TEST(SignatureTest, SetWords)
{
    ...
    std::vector<cv::Matx33f> words3Covariances = {cv::Matx33f::eye()*0.9f, cv::Matx33f::eye()*0.8f, cv::Matx33f::eye()*0.7f};
...
TEST(SignatureTest, SetWordsWithInvalidWords)
{
    ...
    std::vector<cv::Matx33f> words3Covariances = {cv::Matx33f::eye()*0.9f, cv::Matx33f::eye()*0.8f, cv::Matx33f::eye()*0.7f, cv::Matx33f::eye()*0.6f};
...
TEST(SignatureTest, SetWordsAllInvalid)
{
    ...
    std::vector<cv::Matx33f> words3Covariances = {cv::Matx33f::eye()*0.5f, cv::Matx33f::eye()*0.6f};
...
TEST(SignatureTest, RemoveAllWords)
{
    ...
    std::vector<cv::KeyPoint> keypoints(2);
    std::vector<cv::Point3f> words3(2);
    std::vector<cv::Matx33f> words3Covariances = {cv::Matx33f::eye()*0.9f, cv::Matx33f::eye()*0.8f};
    cv::Mat descriptors = cv::Mat::zeros(2, 32, CV_8UC1);
...
TEST(SignatureTest, SetWordsDisablesSignature)
{
    ...
    std::vector<cv::Matx33f> words3Covariances = {cv::Matx33f::eye()*0.5f};
...
TEST(SignatureTest, CompareTo)
{
    ...
    std::vector<cv::Matx33f> words3Covariances_1 = {cv::Matx33f::eye()*0.9f, cv::Matx33f::eye()*0.8f, cv::Matx33f::eye()*0.7f};
    cv::Mat descriptors1 = cv::Mat::zeros(3, 32, CV_8UC1);
    
    sig1.setWords(words1, keypoints1, words3_1, words3Covariances_1, descriptors1);
    ...
    std::vector<cv::Matx33f> words3Covariances_2 = {cv::Matx33f::eye()*0.9f, cv::Matx33f::eye()*0.8f, cv::Matx33f::eye()*0.7f};
    cv::Mat descriptors2 = cv::Mat::zeros(3, 32, CV_8UC1);
    
    sig2.setWords(words2, keypoints2, words3_2, words3Covariances_2, descriptors2);
...
TEST(SignatureTest, CompareToIdentical)
{
    ...
    sig1.setWords(words, keypoints, words3, words3Covariances, descriptors);
    sig2.setWords(words, keypoints, words3, words3Covariances, descriptors);
